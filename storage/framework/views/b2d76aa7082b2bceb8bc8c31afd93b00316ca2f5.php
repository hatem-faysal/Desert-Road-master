<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="d-flex justify-content-between mb20">
            <h1 class="title-bar"><?php echo e(!empty($recovery) ? __('Recovery') : __("All Package")); ?></h1>
            <div class="title-actions">
                <?php if(empty($recovery)): ?>
                <a href="<?php echo e(route('tour.admin.create')); ?>" class="btn btn-primary"><?php echo e(__("Add new package")); ?></a>
                <?php endif; ?>
            </div>
        </div>
                            ...
                            <?php if($rows->total() > 0): ?>
                                <?php $__currentLoopData = $rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="<?php echo e($row->status); ?>">
                                        ...
                                        <td>
                                        <?php
                                        $countNew = Modules\Tour\Models\TravelLocation::where('tour_id',$row->id)->get();
                                        ?>
                                        <?php $__currentLoopData = $countNew; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="badge badge-publish"><?php echo e($data->Location->name??''); ?></span>
                                            <br/>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if(empty($recovery)): ?>
                                                <a href="<?php echo e(route('multilocation.admin.index',['id'=>$row->id])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo e(__('Multi Location')); ?></a>
                                            <?php endif; ?>
                                        </td>
                                        <td>
                                            <?php if(empty($recovery)): ?>
                                                <a href="<?php echo e(route('multiroom.admin.index',['id'=>$row->id])); ?>" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i> <?php echo e(__('Multi Room')); ?></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hatem/Desktop/desertroad/modules/Tour/Views/admin/index.blade.php ENDPATH**/ ?>