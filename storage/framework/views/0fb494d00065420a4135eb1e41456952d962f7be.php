<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('multilocation.admin.update',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Edit Multi Location: ').$row->title : __('Add new package')); ?></h1>
                    <?php if($row->slug): ?>
            ...
            <div class="lang-content-box">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <?php echo $__env->make('Tour::admin/tour/index-multilocation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-md-3">
                        <div class="panel">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hatem/Desktop/desertroad/modules/Tour/Views/admin/multilocation.blade.php ENDPATH**/ ?>