    ...
    <form action="<?php echo e(route('tour.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])); ?>" method="post">
        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between mb20">
                <div class="">
                    <h1 class="title-bar"><?php echo e($row->id ? __('Edit: ').$row->title : __('Add new package')); ?></h1>
                    <?php if($row->slug): ?>
                ...
                <div class="">
                    <?php if($row->slug): ?>
                        <a class="btn btn-primary btn-sm" href="<?php echo e($row->getDetailUrl(request()->query('lang'))); ?>" target="_blank"><?php echo e(__("View Package")); ?></a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="lang-content-box">
                <div class="row">
                    ...
                    <?php if(is_default_lang()): ?>
                        ...
                        <?php endif; ?>
                       <?php echo $__env->make('Tour::admin/tour/date', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <?php if(is_default_lang()): ?>
                            <div class="panel">
                                <div class="panel-title"><strong><?php echo e(__("Package Featured")); ?></strong></div>
                                <div class="panel-body">
                                    <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/hatem/Desktop/desertroad/modules/Tour/Views/admin/detail.blade.php ENDPATH**/ ?>