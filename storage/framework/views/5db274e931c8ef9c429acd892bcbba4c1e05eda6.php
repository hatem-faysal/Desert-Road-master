...
<div class="item-tour <?php echo e($wrap_class ?? ''); ?>">
    ...
    <div class="location">
        <?php
                 $TravelLocation = Modules\Tour\Models\TravelLocation::where('tour_id',$row->id)->get('location_id')->toArray();
                 $LocationNew = Modules\Location\Models\Location::whereIn('id',$TravelLocation)->get();
        ?>
        <?php $__currentLoopData = $LocationNew; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(!empty($location->name)): ?>
                    <?php $location =  $location->translate() ?>
...
<?php /**PATH /home/hatem/Desktop/desertroad/themes/BC/Tour/Views/frontend/layouts/search/loop-grid.blade.php ENDPATH**/ ?>