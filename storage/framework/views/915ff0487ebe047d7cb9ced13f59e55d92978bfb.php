<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Package Content")); ?></strong></div>
    <div class="panel-body">
        <div class="form-group">
            <label><?php echo e(__("Title")); ?></label>
            <input type="text" value="<?php echo clean($translation->title); ?>" placeholder="<?php echo e(__("Package title")); ?>" name="title" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group-item">
                ...
                <?php if(!empty($translation->faqs)): ?>
                    ...
                    <?php $__currentLoopData = $translation->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="item" data-number="<?php echo e($key); ?>">
                            <div class="row">
                                <div class="col-md-5">
                                    <input type="text" name="faqs[<?php echo e($key); ?>][title]" class="form-control" value="<?php echo e($faq['title']); ?>" placeholder="<?php echo e(__('Eg: When and where does the package end?')); ?>">
                                </div>
                                <div class="col-md-6">
            ...
            <div class="g-more hide">
                <div class="item" data-number="__number__">
                    <div class="row">
                        <div class="col-md-5">
                            <input type="text" __name__="faqs[__number__][title]" class="form-control" placeholder="<?php echo e(__('Eg: When and where does the package end?')); ?>">
                        </div>
                        <div class="col-md-6">
...
<?php /**PATH /home/hatem/Desktop/desertroad/modules/Tour/Views/admin/tour/tour-content.blade.php ENDPATH**/ ?>