<div class="panel">
    <div class="panel-title"><strong><?php echo e(__("Package Locations")); ?></strong></div>
    <div class="panel-body">
        ...
        <?php endif; ?>
        <div class="form-group">
            <label class="control-label"><?php echo e(__("Real Package address")); ?></label>
            <input type="text"  name="address" id="customPlaceAddress" class="form-control" placeholder="<?php echo e(__("Real Package address")); ?>" value="<?php echo e($translation->address); ?>">
        </div>
        <?php if(is_default_lang()): ?>
            <div class="form-group">
...
<?php /**PATH /home/hatem/Desktop/desertroad/modules/Tour/Views/admin/tour/tour-location.blade.php ENDPATH**/ ?>