...
<?php
         $TravelLocation = Modules\Tour\Models\TravelLocation::where('tour_id',$row->id)->get();
?>
<?php $__currentLoopData = $TravelLocation; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /home/hatem/Desktop/desertroad/themes/BC/Tour/Views/frontend/layouts/details/tour-detail.blade.php ENDPATH**/ ?>