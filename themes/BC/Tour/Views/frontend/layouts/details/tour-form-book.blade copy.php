                    ...
                    <div class="form-group form-date-field form-date-search clearfix " data-format="{{get_moment_date_format()}}">
                        ...
                        <div class="date-wrapper clearfix"  v-else>
                            <div class="check-in-wrapper">
                                ...
                                <div class="render check-in-render">10/13/2023 <i class="fa fa-long-arrow-right" style="font-size: inherit"></i> 11/23/2023</div>
                            </div>
                        </div>
                        <input type="text" class="start_date" value="{{ $row->start_date->format('m/d/Y').'-'.$row->end_date->format('m/d/Y') }}" ref="start_date" style="height: 1rem; visibility:hidden ">
                    </div>
