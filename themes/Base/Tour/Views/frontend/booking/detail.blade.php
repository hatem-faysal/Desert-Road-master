        ...
        <div class="review-section total-review">
            <ul class="review-list">
                ...
                @else
                    ...
                    <li>
                        <div class="label">{{__("Guests")}}: {{$booking->total_guests}} * {{format_money($booking->MulteRoom->price??'')}}</div>
                        <div class="val">
                        @if (isset($booking->MulteRoom->price))
                            {{format_money($booking->MulteRoom->price * $booking->total_guests)}}
                        @endif
                        </div>
                    </li>
                @endif
                ...
                <li class="final-total d-block">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="val">{{format_money($booking->total * $booking->total_guests)}}</div>
