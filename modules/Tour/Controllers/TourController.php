<?php
    ...
    class TourController extends Controller
    {
        ...
        public function __construct(Tour $tour)
        {
            ...
            $this->multeRoomClass = MulteRoom::class;
            $this->tourCategoryClass = TourCategory::class;
            $this->attributesClass = Attributes::class;
        }
        
        public function tourCall($id){
            $a = $this->multeRoomClass::where('tour_id',$id)->get();
            return ($a);
        }
        ...
        public function index(Request $request)
        {
            ...
            $travelLocation = $this->travelLocation::where('location_id',Request('location_id'))->get('tour_id')->toArray();
            if(!empty(Request('location_id'))){
                $query->whereIn('bravo_tours.id',$travelLocation);
            }
