...
class StripeCheckoutGateway extends BaseGateway
{
    ...
    public function process(Request $request, $booking, $service)
    {
        ...
        $payment->amount = (float) $booking->pay_now * $booking->total_guests;
            ...
            'line_items'=>[
                [
                    'price_data'=>[
                        ...
                        'unit_amount'=>(float) $booking->pay_now * $booking->total_guests * 100
                    ],
                    'quantity'=>1
                ]
            ]
    ...
    public function confirmPayment(Request $request)
    {
        ...
        if (!empty($booking) and in_array($booking->status, [$booking::UNPAID])) {
            ...
            // hatem
                $booking->paid += (float)$booking->pay_now * $booking->total_guests;
                $booking->markAsPaid();
