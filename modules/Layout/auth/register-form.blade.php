...
<form class="form bravo-form-register" method="post" action="{{route('auth.register.store')}}">
    ...
    <div class="form-group">
        <input type="text" class="form-control"  id="telephone" name="phone" autocomplete="off" placeholder="{{__('Phone')}}">
    ...
    <div class="form-group">
        <input type="date" class="form-control" name="birthday" autocomplete="off" placeholder="{{__('birthday of Birth')}}">
    ...
    <div class="form-group">
        <input type="password" class="form-control" name="confirm_password" autocomplete="off" placeholder="{{__('Confirm Password')}}">
        <i class="input-icon field-icon icofont-ui-password"></i>
    ...
    <div class="form-group">
        <label for="term">
            ...
            {!! __("You should be at least 18 years of age") !!}
            <span class="checkmark fcheckbox"></span>
        </label>
